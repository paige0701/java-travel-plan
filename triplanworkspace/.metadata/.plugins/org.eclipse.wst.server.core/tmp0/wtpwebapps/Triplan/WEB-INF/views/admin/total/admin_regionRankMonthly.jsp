		...
		$("#chart1").empty(); 
		 ...
		 $.ajax({
			 ...
			 success: function(data) {  
					...
					var resultHtml = "<table id='datatale' class='table'>";
					    resultHtml += "<tr>";
					    resultHtml += "<th>랭크</th>";
					    resultHtml += "<th>지역</th>";
...
<body>
	...
	<div align="center"><input type="month" id="theDate" /></div>
	...
	<br/>
	<div id="graph1" style="width: 70%; height: 100%; margin: 0 auto ;"></div>
	...
	<table id="datatable" class="table" style="margin-top:5%;margin-bottom:5%;  width: 68%; text-align: center;" >
			...
			<c:if test="${list == null }"><tr><td colspan="3">없엉</td></tr>></c:if>
			<c:if test="${list != null }">
